...
echo "
        ...
        <input type='text' name='descripcion' placeholder='Descripción' maxlength='200' value='".$descripcion."' required><br><br>";
...
echo "	
        <input type='submit'>
        <p><a href='index.php' class='logout-link'>Volver</a></p>
        </form>
        </div>";
